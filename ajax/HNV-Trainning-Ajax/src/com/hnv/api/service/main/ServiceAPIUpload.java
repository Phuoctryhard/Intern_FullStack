...
public class ServiceAPIUpload implements IServiceCallback{
	private static final String PARAM_FILE = "file_data";
	...
	public void doService(
			...
			@RequestParam(PARAM_FILE) 			MultipartFile[] 	files,
...
//			return ResponseEntity.status(HttpStatus.EXPECTATION_FAILED).body(new ServiceResponse(message));
	...
	@Override
	public void doCallBack(HttpServletRequest request, HttpServletResponse response, Object... params) throws Exception {
